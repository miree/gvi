...
GVI generates glue code that allows to run Verilog modules inside of VHDL testbenches. Have a look at the examples to see how it works. In order to run the m-labs-lm32 example, git submodules have to be activated (git submodule init; git submodule update;)
